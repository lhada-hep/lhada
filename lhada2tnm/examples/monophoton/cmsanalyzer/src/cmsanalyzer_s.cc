...
//
// Created:     Sun Oct 14 13:32:07 2018 by lhada2tnm.py
//------------------------------------------------------------------
#include <algorithm>
#include "cmsanalyzer_s.h"
...
double	_Meff(vector<TEParticle>& jets, TLorentzVector& MET)
{
  ...
  copy(jets.begin(), jets.end(), jets_.begin());
...
void cmsanalyzer_s::run(std::vector<TEParticle>& Delphes_Muon_,
...
void cmsanalyzer_s::summary(TFile* fout, ostream& os)
{
