...
struct eventBuffer
{
  ...
  void initBuffers()
  {
    ...
    Jet_DeltaEta	= std::vector<float>(25,0);
    ...
    Jet_NNeutrals	= std::vector<int>(25,0);
    Jet_NSubJetsPruned	= std::vector<int>(25,0);
    Jet_NSubJetsSoftDropped	= std::vector<int>(25,0);
    Jet_NSubJetsTrimmed	= std::vector<int>(25,0);
    Jet_PT	= std::vector<float>(25,0);
    ...
    Photon_IsolationVar	= std::vector<float>(15,0);
    Photon_IsolationVarRhoCorr	= std::vector<float>(15,0);
    Photon_PT	= std::vector<float>(15,0);
    Photon_Phi	= std::vector<float>(15,0);
    Photon_SumPt	= std::vector<float>(15,0);
    Photon_SumPtCharged	= std::vector<float>(15,0);
